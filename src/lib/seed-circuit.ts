...
export const mysuuruTurfs = [
  {
    ...
    area: "Bogadi",
    address: "Sy 85/2, near sea food joint, Bogadi 2nd Stage North, Mysuru, Karnataka 570026",
    city: "Mysuru",
    sports: ["Football"],
  ...
  },
  {
    ...
    name: "Pebbly Sports Club",
    area: "Bhogadi",
    address: "No.94/7, Saluhundi, Kergalli, Mysuru, Karnataka 570008",
    city: "Mysuru",
    ...
    isActive: true,
    isPremium: true,
    imageUrl: "https://picsum.photos/seed/pebbly/1200/800",
    description: "Sports club with turf facilities for matches and local tournaments.",
    rules: ["Open 24 hours", "Proper gear required", "Respect neighbors"],
